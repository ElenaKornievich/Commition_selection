...
public class CreateSpecialityCommand implements BaseCommand {
    ...
    private CreateSpecialityCommand() {
    }
        ...
        try {
            if (SpecialityService.getInstance().findSpecialityByName(nameSpeciality) != null) {
                request.setAttribute(AttributeConstant.ATTRIBUTE_ERROR_MASSAGE,
                        ErrorMassageConstant.CREATE_SPECIALITY_ERROR);
                return PageConstant.PAGE_ERROR;
            }
            SpecialityService.getInstance()
                    .createSpeciality(nameSpeciality, facultyId, numberOfBudgetPlaces, numberOfPainPlaces);
    ...
    public String getPage(HttpServletRequest request) {
        ...
        try {
            request.getSession().setAttribute(AttributeConstant.ATTRIBUTE_FACULTIES,
        ...
        request.setAttribute(AttributeConstant.ATTRIBUTE_NAVIGATION,
                PageConstant.PAGE_ADMIN_PANEL_CREAT_SPECIALITY);
        return PageConstant.PAGE_ADMIN_PANEL;
    }
}
